...
mkdir -p $BUILD_DIR/generated-configs/depot
...
LEGEND_DEPOT_PORT=$(echo $(grep -v '^#' $DOTENV_FILE | grep -e "LEGEND_DEPOT_PORT" | sed -e 's/.*=//'))
LEGEND_DEPOT_PUBLIC_URL=http://$HOST_ADDRESS:$LEGEND_DEPOT_PORT
LEGEND_DEPOT_STORE_PORT=$(echo $(grep -v '^#' $DOTENV_FILE | grep -e "LEGEND_DEPOT_STORE_PORT" | sed -e 's/.*=//'))
LEGEND_DEPOT_STORE_PUBLIC_URL=http://$HOST_ADDRESS:$LEGEND_DEPOT_STORE_PORT
...
SED_CMD 's~__LEGEND_DEPOT_PUBLIC_URL__~'$LEGEND_DEPOT_PUBLIC_URL'~g' $DOTENV_FILE
SED_CMD 's~__LEGEND_DEPOT_STORE_PUBLIC_URL__~'$LEGEND_DEPOT_STORE_PUBLIC_URL'~g' $DOTENV_FILE